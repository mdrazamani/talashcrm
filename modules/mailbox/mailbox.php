...
//{
//    $CI = & get_instance();
//    $CI->load->library(MAILBOX_MODULE_NAME.'/Envapi');
//    $envato_res = $CI->envapi->validatePurchase(MAILBOX_MODULE_NAME);
//    if (!$envato_res) {
...
//        if (!option_exists(MAILBOX_MODULE_NAME.'_verified') && empty(get_option(MAILBOX_MODULE_NAME.'_verified')) && !option_exists(MAILBOX_MODULE_NAME.'_verification_id') && empty(get_option(MAILBOX_MODULE_NAME.'_verification_id'))) {
//            $CI = & get_instance();
//            $data['submit_url'] = $module_name['system_name'].'/env_ver/activate';
//            $data['original_url'] = admin_url('modules/activate/'.MAILBOX_MODULE_NAME);
//            $data['module_name'] = MAILBOX_MODULE_NAME;
...
{
    if ($module_name['system_name'] == MAILBOX_MODULE_NAME) {
        delete_option(MAILBOX_MODULE_NAME."_verified");
