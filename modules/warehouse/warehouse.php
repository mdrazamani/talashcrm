    ...
    if (has_permission('warehouse', '', 'view')) {
       ...
       $CI->app_menu->add_sidebar_menu_item('warehouse', [
        ...
        $CI->app_menu->add_sidebar_children_item('warehouse', [
            ...
            'name'     => _l('حواله های ورود به انبار'),
        ...
        $CI->app_menu->add_sidebar_children_item('warehouse', [
            ...
            'name'     => _l('حواله های خروج از انبار'),
