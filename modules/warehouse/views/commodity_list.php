    ...
    <div class="modal-dialog ht-dialog-width">
      ...
      <div class="modal-content">
            ...
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                <h4 class="modal-title">
                    <span class="edit-commodity-title"><?php echo _l('ویرایش'); ?></span>
                    <span class="add-commodity-title"><?php echo _l('افزودن کالای جدید'); ?></span>
                </h4>
            </div>
                  ...
                  <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                   <li role="presentation" class="active">
                    ...
                    <li role="presentation">
                       ...
                       <i class="fa fa-bars menu-icon"></i>&nbsp;<?php echo _l('تغییر'); ?>
                       </a>
                    </li>

                    <li role="presentation">
                       <a href="#custom_fields" aria-controls="custom_fields" role="tab" data-toggle="tab" aria-controls="custom_fields">
                       <i class="fa fa-bars menu-icon"></i>&nbsp;<?php echo _l('فیلد دلخواه'); ?>
                       </a>
                    </li>
                  ...
                  <div role="tabpanel" class="tab-pane active" id="interview_infor">
                        <div class="row parent_item_hide">
                          <div class=" col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <?php echo render_input('commodity_code', 'کد کالا'); ?>
                                </div>
                                <div class="col-md-6">
                                  <?php echo render_input('description', 'عنوان کالا'); ?>
                                </div>
                            ...
                            <div class="row">
                               <div class="col-md-6">
                                     <?php echo render_input('commodity_barcode', 'بارکد کالا','','text'); ?>
                                </div>
                              <div class="col-md-3">
                                ...
                                <?php echo render_input('sku_code', 'کد sku','',''); ?>
                              </div>
                              <div class="col-md-3">
                                <?php echo render_input('sku_name', 'نام sku'); ?>
                              </div>
                            </div>
                              ...
                              <div class="col-md-12">
                                  <div class="form-group" id="tags_value">
                                    <div id="inputTagsWrapper">
                                       <label for="tags" class="control-label"><i class="fa fa-tag" aria-hidden="true"></i> <?php echo _l('برچسب'); ?></label>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                    <?php echo render_textarea('long_description', 'شرح کالا'); ?>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                  <?php echo render_select('warehouse_id',$warehouses,array('warehouse_id',array('warehouse_code','warehouse_name')),'نام انبار'); ?>
                              </div>
                            </div>

                            <div class="row">
                                <div class="col-md-6">
                                     <?php echo render_select('commodity_type',$commodity_types,array('commodity_type_id','commondity_name'),'نوع کالا'); ?>

                                </div>
                                 <div class="col-md-6">
                                     <?php echo render_select('unit_id',$units,array('unit_type_id','unit_name'),'واحدها'); ?>
                                </div>
                            </div>
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-6">
                                     <?php echo render_select('group_id',$commodity_groups,array('id','name'),'گروه کالایی'); ?>
                                </div>
                                 <div class="col-md-6">
                                     <?php echo render_select('sub_group',$sub_groups,array('id','sub_group_name'),'زیر گروه ها'); ?>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                  <?php 
                                   ...
                                   ?>
                                     <?php echo render_input('profif_ratio','نرخ سود پیش فرض','','number',$attr); ?>
                                </div>
                                <div class="col-md-3">
                                     <?php echo render_select('tax',$taxes,array('id','name'),'مالیات1'); ?>
                                </div>
                                <div class="col-md-3">
                                     <?php echo render_select('tax2',$taxes,array('id','name'),'مالیات2'); ?>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    //$attr = ['data-type' => 'currency'];
                                     echo render_input('purchase_price', 'قیمت خرید','', 'number', $attr); ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    $attr = array();
                                     //$attr = ['data-type' => 'currency'];
                                     echo render_input('rate', 'قیمت فروش','', 'number', $attr); ?>
                            ...
                            <div id="dropzoneDragArea" class="dz-default dz-message">
                               <span><?php echo _l('تصویر مورد نظر برای محصول فوق را اینجا بکشید و رها کنید...'); ?></span>
                            </div>
                  ...
                  <div role="tabpanel" class="tab-pane" id="interview_evaluate">
                    ...
                    <div class="col-md-12">
                     ...
                     <div class="form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <?php echo render_input('origin', 'برند یا کشور سازنده'); ?>
                            </div>
                            <div class="col-md-6">
                                 <?php echo render_select('style_id',$styles,array('style_type_id','style_name'),'سبک ها'); ?>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-6">
                                 <?php echo render_select('model_id',$models,array('body_type_id','body_name'),'مدل'); ?>
                            </div>
                            <div class="col-md-6">
                                 <?php echo render_select('size_id',$sizes,array('size_type_id','size_name'),'اندازه ها'); ?>
                            </div>
                        </div>

                        <div class="row">
                          <div class="col-md-6">
                            <?php echo render_select('color',$colors,array('color_id',array('color_hex','color_name')),'رنگ'); ?>
                          </div>
                          <div class="col-md-6">
                            <?php $attr = array();
                                  $attr = ['min' => 0, 'step' => 1]; ?>

                            <?php echo render_input('guarantee','گارانتی (ماه)','', 'number', $attr); ?>
                          </div>
                        </div>
                          ...
                          <div class="col-md-6">
                              <div class="form-group">
                                <div class="checkbox checkbox-primary">
                                  ...
                                  <label for="without_checking_warehouse"><?php echo _l('شماره موجودی را به‌روزرسانی نکنید'); ?><small ><?php echo _l('(وقتی رسید موجودی یا تحویل موجودی برای این کالا ایجاد می‌شود، مقدار موجودی به‌روزرسانی نمی‌شود)') ?> </small>
                                  </label>
                                </div>
                              </div>
                          </div>
                          ...
                          <div class="col-md-3 col-sm-6">
                           <div class="form-group">
                            <div class="checkbox checkbox-primary">
                              ...
                              <label for="can_be_sold"><?php echo _l('قابل فروش است'); ?></label>
                            </div>
                            <div class="checkbox checkbox-primary <?php if(!get_status_modules_wh('purchase')){echo ' hide';} ?>">
                              ...
                              <label for="can_be_purchased"><?php echo _l('قابل خرید است'); ?></label>
                            </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                          <div class="form-group">
                            <div class="checkbox checkbox-primary">
                              ...
                              <label for="can_be_inventory"><?php echo _l('می تواند موجودی باشد'); ?></label>
                            </div>
                            <div class="checkbox checkbox-primary <?php if(!get_status_modules_wh('manufacturing')){echo ' hide';} ?>">
                              ...
                              <label for="can_be_manufacturing"><?php echo _l('می تواند تولید باشد'); ?></label>
                            </div>
                          </div>
                        </div>  
                        </div>  
                        ...
                        <div class="row">
                          <div class="col-md-12 ">
                              <p class="bold"><?php echo _l('توضیحات طولانی'); ?></p>
                      ...
                      <div class="list_approve">
                        <div id="item_approve">
                          <div class="col-md-11">
                            ...
                            <div class="col-md-4">
                              <?php echo render_input('name[0]','نام تغییر','', 'text'); ?>
                           </div>
                           <div class="col-md-8">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo _l('انصراف') ?></button>
                <button type="submit" class="btn btn-info"><?php echo _l('ذخیره'); ?></button>
            </div>
          </div>
