			...
			<div class="col-md-12" id="small-table">
				<div class="panel_s">
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-2">
								<?php echo render_date_input('from_date', 'از تاریخ', $from_date); ?>
							</div>
							<div class="col-md-2">
								<?php echo render_date_input('to_date', 'تا تاریخ', $to_date); ?>
							</div>
							<div class="col-md-3">
								<?php echo render_select('staff_id[]', $staffs, array('staffid', array('full_name')), 'کارکنان', '', ['multiple' => true, 'data-width' => '100%', 'class' => 'selectpicker', 'data-live-search' => "true"], array(), '', '', false); ?>
							</div>
							<div class="col-md-3">
								<?php echo render_select('delivery_id[]', $get_goods_delivery, array('id', array('goods_delivery_code')), 'بن تحویل موجودی', '', ['multiple' => true, 'data-width' => '100%', 'class' => 'selectpicker', 'data-live-search' => "true"], array(), '', '', false); ?>
							</div>
							<?php 
							$packing_list_status = [];
							$packing_list_status[] = [
							...
							$packing_list_status[] = [
							 ...
							 ?>
							<div class="col-md-2">
								<?php echo render_select('status_id[]', $packing_list_status, array('id', array('label')), 'وضعیت', $status_id, ['multiple' => true, 'data-width' => '100%', 'class' => 'selectpicker'], array(), '', '', false); ?>
							</div>
						...
						<?php render_datatable(array(
							_l('id'),
							_l('شماره لیست بسته بندی'),
							_l('مشتری'),
							_l('بعد،ابعاد،اندازه'),
							_l('حجم(m3)'),
							_l('مبلغ کل'),
							_l('مجموع تخفیف'),
							_l('کل به همراه تخفیف'),
							_l('تاریخ ایجاد'),
							_l('وضعیت'),
							_l('وضعیت تحویل'),
