...
function app_init_project_tabs()
{
    ...
    //---------------------------------------------
    $CI->app_tabs->add_project_tab('project_thisViews', [
        'name'     => 'tabNameNullSee',
        'icon'     => 'fa fa-gavel',
        'position' => 10,
        'collapse' => true,
    ]);
    $CI->app_tabs->add_project_tab_children_item('project_thisViews', [
        'slug'     => 'project_thisViews_lead',
        'name'     => _l('اقدام'),
        'view'     => 'admin/projects/thisViews/myProces',
        'position' => 5,
    ]);
    $CI->app_tabs->add_project_tab_children_item('project_thisViews', [
        'slug'     => 'project_thisViews_proposal',
        'name'     => _l('پیشنهاد نهایی'),
        'view'     => 'admin/projects/thisViews/myProposal',
        'position' => 10,
    ]);
    $CI->app_tabs->add_project_tab_children_item('project_thisViews', [
        'slug'     => 'project_thisViews_sends',
        'name'     => _l('ارسالی ها'),
        'view'     => 'admin/projects/thisViews/mySends',
        'position' => 10,
    ]);
    $CI->app_tabs->add_project_tab_children_item('project_thisViews', [
        'slug'     => 'project_thisViews_gives',
        'name'     => _l('دریافتی ها'),
        'view'     => 'admin/projects/thisViews/myGives',
        'position' => 15,
    ]);
    $CI->app_tabs->add_project_tab_children_item('project_thisViews', [
        'slug'     => 'project_thisViews_systems_gives',
        'name'     => _l('دریافتی های سیستمی'),
        'view'     => 'admin/projects/thisViews/mySystemGives',
        'position' => 20,
    ]);
    $CI->app_tabs->add_project_tab_children_item('project_thisViews', [
        'slug'     => 'project_thisViews_list',
        'name'     => _l('لیست'),
        'view'     => 'admin/projects/thisViews/myLists',
        'position' => 25,
    ]);
    $CI->app_tabs->add_project_tab_children_item('project_thisViews', [
        'slug'     => 'project_thisViews_Pms',
        'name'     => _l('پیام ها'),
        'view'     => 'admin/projects/thisViews/myPms',
        'position' => 30,
    ]);
    $CI->app_tabs->add_project_tab_children_item('project_thisViews', [
        'slug'     => 'project_thisViews_requests',
        'name'     => _l('درخواست ها'),
        'view'     => 'admin/projects/thisViews/myRequests',
        'position' => 35,
    ]);
    //---------------------------------------------
