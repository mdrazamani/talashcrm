...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/crm/perfex_crm/assets/fonts/fonts.css">
  ...
  input[type="color"]:focus {
    ...
    box-shadow: 0 0 0 2.5px rgba(0, 112, 240, 0.3);
    /*box-shadow: none;*/
    outline: 0 none;
    transition: border-color 3s ease-in-out, box-shadow 0.15s ease-in-out;
  }
