...
<div class="modal fade" id="pre_invoice_project_settings" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    <?php echo _l('اطلاعات فاکتور پروژه'); ?>
                </h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="radio radio-primary">
                                    ...
                                    <label for="single_line"><?php echo _l('تک خط'); ?> <?php if($billing_type == 1){echo ' [ '._l('نرخ ثابت').' ]';} ?></label>
                                </div>
                            </div>
                            ...
                            <div class="col-md-10">
                                <div class="radio radio-primary">
                                    ...
                                    <label for="task_per_item"><?php echo _l('وظیفه در هر مورد'); ?></label>
                                </div>
                            </div>
                            <div class="col-md-2 mtop10 text-right">
                            ...
                            <div class="col-md-10">
                                <div class="radio radio-primary">
                                    ...
                                    <label for="timesheets_individualy"><?php echo _l('همه جدول زمانی به صورت جداگانه'); ?></label>
                                </div>
                        ...
                        <?php } else { ?>
                        <hr />
                        <a href="#" onclick="slideToggle('#pre_invoice_project_tasks'); return false;"><b class="label label-info font-medium-xs inline-block"><?php echo _l('هزینه هایی را که در این فاکتور صورتحساب می شود را ببینید'); ?></b></a>
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-info" onclick="invoice_project(<?php echo $project_id; ?>)"><?php echo _l('فاکتور پروژه'); ?></button>
            <?php } ?>
        </div>
    </div>
    <!-- /.modal-content -->
