                ...
                <div class="mz-panel-body">
                    ...
                    <div class="col-md-3">
                        <div class="checkbox checkbox-success">
                            ...
                            <label for="taedee[kharegi][0]['key']"  class="control-label"> <small class="req text-danger">* </small>فروش 1</label>
                            <p>توضیح فروش 1</p>

                            <input type="hidden" id="taedee[kharegi][0]['value']" name="taedee[kharegi][0]['value']" value="فروش 1">
                            <input type="hidden" id="taedee[kharegi][0]['desc']" name="taedee[kharegi][0]['desc']" value="توضیح فروش 1">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="checkbox checkbox-success">
                            <input type="checkbox" id="taedee[kharegi][1]['key']" name="taedee[kharegi][1]['key']" value="1">
                            <label for="taedee[kharegi][1]['key']" class="control-label"> <small class="req text-danger">* </small>فروش 2</label>
                            <p>توضیح فروش 2</p>

                            <input type="hidden" id="taedee[kharegi][1]['value']" name="taedee[kharegi][1]['value']" value="فروش 2">
                            <input type="hidden" id="taedee[kharegi][1]['desc']" name="taedee[kharegi][1]['desc']" value="توضیح فروش 2">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="checkbox checkbox-success">
                            <input type="checkbox" id="taedee[kharegi][2]['key']" name="taedee[kharegi][2]['key']" value="1">
                            <label for="taedee[kharegi][2]['key']" class="control-label"> <small class="req text-danger">* </small>فروش 3</label>
                            <p>توضیح فروش 3</p>

                            <input type="hidden" id="taedee[kharegi][2]['value']" name="taedee[kharegi][2]['value']" value="فروش 3">
                            <input type="hidden" id="taedee[kharegi][2]['desc']" name="taedee[kharegi][2]['desc']" value="توضیح فروش 3">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="checkbox checkbox-success">
                            <input type="checkbox" id="taedee[kharegi][3]['key']" name="taedee[kharegi][3]['key']" value="1">
                            <label for="taedee[kharegi][3]['key']" class="control-label"> <small class="req text-danger">* </small>فروش 4</label>
                            <p>توضیح فروش 4</p>

                            <input type="hidden" id="taedee[kharegi][3]['value']" name="taedee[kharegi][3]['value']" value="فروش 4">
                            <input type="hidden" id="taedee[kharegi][3]['desc']" name="taedee[kharegi][3]['desc']" value="توضیح فروش 4">
                        </div>
                    </div>
