...
<div class="modal fade" id="contact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div id="contact-profile-image" class="form-group<?php if(isset($contact) && !empty($contact->profile_image)){echo ' hide';} ?>">
                            <label for="profile_image" class="profile-image"><?php echo _l('تصویر پروفایل'); ?></label>
                        ...
                        <?php echo render_input( 'firstname', 'نام',$value); ?>
                        <?php $value=( isset($contact) ? $contact->lastname : ''); ?>
                        <?php echo render_input( 'lastname', 'نام خانوادگی',$value); ?>
                        <?php $value=( isset($contact) ? $contact->title : ''); ?>
                        <?php echo render_input( 'title', 'موقعیت شغلی',$value); ?>
                        <?php $value=( isset($contact) ? $contact->email : ''); ?>
                        <?php echo render_input( 'email', 'ایمیل',$value, 'email'); ?>
                        <?php
                            if(!isset($contact)) {
                                $value = $calling_code ?: '';
                            } else {
                        ...
                        ?>
                        <?php echo render_input( 'phonenumber', 'تلفن همراه',$value,'text',array('autocomplete'=>'off')); ?>
                        <div class="form-group contact-direction-option">
                          <label for="direction"><?php echo _l('جهت نمایش'); ?></label>
                        ...
                        <div class="form-group contact-direction-option">
                            <label for="direction"><?php echo _l('جنسیت'); ?></label>
                            <select class="selectpicker" data-none-selected-text="<?php echo _l('system_default_string'); ?>" data-width="100%" name="sex" id="sex">
                                <option value="male" <?php if(isset($contact) && $contact->sex == 'male'){echo 'selected';} ?>>مذکر</option>
                                <option value="female" <?php if(isset($contact) && $contact->sex == 'female'){echo 'selected';} ?>>مونث</option>
                            </select>
                        </div>
                ...
                <div class="checkbox checkbox-primary">
                    ...
                    <label for="donotsendwelcomeemail">
                        <?php echo _l( 'ایمیل خوش آمدگویی ارسال نشود'); ?>
                    </label>
                </div>
                <?php } ?>
                ...
                <div class="checkbox checkbox-primary">
                    ...
                    <label for="send_set_password_email">
                        <?php echo _l( 'رمز عبورش را خودش داخل ایمیل تنظیم کند'); ?>
                    </label>
                </div>
                <?php } ?>
                <hr />
                <p class="bold"><?php echo _l('مجوز ها'); ?></p>
                <p class="text-danger"><?php echo _l('مطمئن شوید که مجوزهای مناسب را برای این مخاطب تنظیم کرده اید'); ?></p>
                <?php
                ...
                <?php } ?>
                 <hr />
                <p class="bold"><?php echo _l('اعلان های ایمیل'); ?><?php if(is_sms_trigger_active()){echo '/SMS';} ?></p>
                <div id="contact_email_notifications">
                <div class="col-md-6 row">
                    <div class="row">
                        <div class="col-md-6 mtop10 border-right">
                            <span><?php echo _l('فاکتور ها'); ?></span>
                        </div>
                        <div class="col-md-6 mtop10">
                            <div class="onoffswitch">
                ...
                <div class="col-md-6 row">
                    <div class="row">
                        <div class="col-md-6 mtop10 border-right">
                            <span><?php echo _l('برآورد ها'); ?></span>
                        </div>
                        <div class="col-md-6 mtop10">
                            <div class="onoffswitch">
                ...
                <div class="col-md-6 row">
                    <div class="row">
                        <div class="col-md-6 mtop10 border-right">
                            <span><?php echo _l('یادداشت اعتباری'); ?></span>
                        </div>
                        <div class="col-md-6 mtop10">
                            <div class="onoffswitch">
                ...
                <div class="col-md-6 row">
                    <div class="row">
                        <div class="col-md-6 mtop10 border-right">
                            <span><?php echo _l('پروژه ها'); ?></span>
                        </div>
                        <div class="col-md-6 mtop10">
                            <div class="onoffswitch">
                ...
                <div class="col-md-6 row">
                    <div class="row">
                        ...
                        <div class="col-md-6 mtop10 border-right">
                            <span><i class="fa fa-question-circle" data-toggle="tooltip" data-title="<?php echo _l('only_project_tasks'); ?>"></i> <?php echo _l('وظایف'); ?></span>
                        </div>
                        <div class="col-md-6 mtop10">
                            <div class="onoffswitch">
                 ...
                 <div class="col-md-6 row">
                    <div class="row">
                        <div class="col-md-6 mtop10 border-right">
                            <span><?php echo _l('قرارداد ها'); ?></span>
                        </div>
                        <div class="col-md-6 mtop10">
                            <div class="onoffswitch">
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-info" data-loading-text="<?php echo _l('wait_text'); ?>" autocomplete="off" data-form="#contact-form"><?php echo _l('ذخیره'); ?></button>
    </div>
    <?php echo form_close(); ?>
</div>
</div>
