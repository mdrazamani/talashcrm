            ...
            <div class="mz-panel">
               <div class="mz-panel-body">
                  <div class="_buttons">
                     ...
                     <?php echo _l('مشتری جدید'); ?></a>
                     <a href="<?php echo admin_url('clients/import'); ?>" class="btn btn-info pull-left display-block mright5 hidden-xs">
                     <?php echo _l('ایمپورت مشتریان'); ?></a>
                     <?php } ?>
                     <a href="<?php echo admin_url('clients/all_contacts'); ?>" class="btn btn-info pull-left display-block mright5">
                     <?php echo _l('مخاطبان'); ?></a>
                     <div class="visible-xs">
                        <div class="clearfix"></div>
                     </div>
                     <div class="btn-group pull-right btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="<?php echo _l('فیلتر توسط'); ?>">
                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="fa fa-filter" aria-hidden="true"></i>
                        </button>
                        <ul class="dropdown-menu dropdown-menu-left" style="width:300px;">
                           <li class="active"><a href="#" data-cview="all" onclick="dt_custom_view('','.table-clients',''); return false;"><?php echo _l('همه'); ?></a>
                           </li>
                           ...
                           <li>
                              ...
                              <?php echo _l('مشتریانی که به من اختصاص داده شده اند'); ?>
                              </a>
                           </li>
                           <li class="divider"></li>
                  ...
                  <div class="row mbot15">
                     ...
                     <div class="col-md-2 col-xs-6">
                        ...
                        <?php
                           ...
                           ?>
                        <?php } ?>
                        <span<?php if($contactsTemplate != ''){ ?> class="pointer text-has-action" data-toggle="popover" data-title="<?php echo _l('customers_summary_logged_in_today'); ?>" data-html="true" data-content="<?php echo $contactsTemplate; ?>" data-placement="bottom" <?php } ?>><?php echo _l('مخاطبین امروز اضافه شده'); ?></span>
                        </span>
                     </div>
                  </div>
                  <?php } ?>
                  ...
                  <div class="checkbox">
                     ...
                     <label for="exclude_inactive"><?php echo _l('مشتریان غیرفعال را حذف کنید'); ?></label>
                  </div>
