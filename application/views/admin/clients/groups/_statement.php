...
<div class="col-md-5">
  <div class="text-right">
    <h4 class="no-margin bold"><?php echo _l('خلاصه حساب'); ?></h4>
    <p class="text-muted"><?php echo _l($from).' تا '._l($to); ?></p>
    <hr />
    <table class="table statement-account-summary">
      <tbody>
        <tr>
          <td class="text-left"><?php echo _l('تعادل ابتدایی'); ?>:</td>
          <td><?php echo app_format_money($statement['beginning_balance'], $statement['currency']); ?></td>
        </tr>
        <tr>
          <td class="text-left"><?php echo _l('مبلغ فاکتور'); ?>:</td>
          <td><?php echo app_format_money($statement['invoiced_amount'], $statement['currency']); ?></td>
        </tr>
        <tr>
          <td class="text-left"><?php echo _l('مبلغ پرداخت شده'); ?>:</td>
          <td><?php echo app_format_money($statement['amount_paid'], $statement['currency']); ?></td>
        </tr>
      </tbody>
      <tfoot>
        <tr>
          <td class="text-left"><b><?php echo _l('سررسید مانده'); ?></b>:</td>
...
<div class="col-md-12">
  <div class="text-center bold padding-10">
    <?php echo _l('نمایش تمام فاکتورها و پرداخت ها از تاریخ').' '._l($from).' تا '._l($to); ?>
  </div>
  <div class="table-responsive">
    <table class="table table-bordered table-striped">
     <thead>
       <tr>
         <th><b><?php echo _l('تاریخ'); ?></b></th>
         <th><b><?php echo _l('جزئیات'); ?></b></th>
         <th class="text-right"><b><?php echo _l('میزان'); ?></b></th>
         <th class="text-right"><b><?php echo _l('مبلغ پرداختی'); ?></b></b></th>
         <th class="text-right"><b><?php echo _l('تعادل'); ?></b></b></th>
       </tr>
     </thead>
     <tbody>
       <tr>
