...
<?php echo _l('سال گذشته'); ?>
</option>
<option value="period"><?php echo _l('تنظیم دستی'); ?></option>
</select>
</div>
<div class="row mtop15">
	<div class="col-md-12 period hide">
		<?php echo render_date_input('period-from','تاریخ شروع','',array('onchange'=>isset($onChange) ? $onChange : '')); ?>
	</div>
	<div class="col-md-12 period hide">
		<?php echo render_date_input('period-to','تاریخ پایان','',array('onchange'=>isset($onChange) ? $onChange : '')); ?>
	</div>
</div>
