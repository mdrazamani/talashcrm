...
<div class="col-md-12">
 ...
 <a href="#" class="btn btn-success mtop15 mbot10" onclick="slideToggle('.usernote'); return false;"><?php echo _l('یادداشت جدید'); ?></a>
...
<div class="row">
 ...
 <div class="usernote hide">
    ...
    <?php echo render_textarea( 'description', 'متن یادداشت', '',array( 'rows'=>5)); ?>
    ...
    <table class="table dt-table" data-order-col="2" data-order-type="desc">
        <thead>
            <tr>
                ...
                <th>
                    <?php echo _l( 'نوشته شده از'); ?>
                </th>
                <th>
                    <?php echo _l( 'تاریخ'); ?>
                </th>
                <th>
                    <?php echo _l( 'گزینه ها'); ?>
                </th>
            </tr>
        </thead>
        <tbody>
