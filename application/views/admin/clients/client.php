...
<?php init_head(); ?>
<?php
$title = (!empty($client->company) ? $client->company : $client->customerName." ".$client->customerFamily);
?>
   ...
   <div class="content">
      <div class="row">
         ...
         <div class="btn-bottom-toolbar btn-toolbar-container-out text-right">
            ...
            <?php echo _l( 'ذخیره و افزودن مخاطب'); ?>
            </button>
            <?php } ?>
         </div>
         <?php } ?>
         <?php if(isset($client)){ ?>
         <div class="col-md-3">
            <div class="mz-panel mbot5">
               <div class="mz-panel-body padding-10">
                  <h4 class="bold">
                     _<?php echo $client->userid . ' ' . $title; ?>
         ...
         <div class="col-md-<?php if(isset($client)){echo 9;} else {echo 12;} ?>">
            <div class="mz-panel">
                <div class="mz-panel-header">
                    <span class="dash-micon"><i class="my-ti <?php if(isset($tab)){ echo _l($tab['icon']); }else{ echo _l('ti ti-user-circle');}?>"></i></span>
                    <span class="dash-mtext"><?php if(isset($tab)){ echo _l($tab['name']); }else{ echo _l('پروفایل');}?></span>
                </div>
