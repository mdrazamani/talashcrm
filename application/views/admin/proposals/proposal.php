               ...
               <div class="panel-body">
                  <div class="row">
                     ...
                     <div class="col-md-6 border-right">
                        ...
                        <?php echo render_input('subject','عنوان پیش فاکتور',$value,'text',$attrs); ?>
                        ...
                        <hr/>
                         ...
                         <div class="col-md-6">
                             <div class="form-group select-placeholder">
                                 <label for="send_time" class="control-label"><?php echo _l('زمان تحویل'); ?></label>
                                 <select name="send_time" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                     <option value="" selected><?php echo _l('لطفا انتخاب کنید'); ?></option>
                                     <option value="<?php echo _l('3 روز کاری'); ?>"><?php echo _l('3 روز کاری'); ?></option>
                                     <option value="<?php echo _l('5 روز کاری'); ?>"><?php echo _l('5 روز کاری'); ?></option>
                                     <option value="<?php echo _l('7 روز کاری'); ?>"><?php echo _l('7 روز کاری'); ?></option>
                                     <option value="<?php echo _l('15 روز کاری'); ?>"><?php echo _l('15 روز کاری'); ?></option>
                                     <option value="<?php echo _l('15 روز کاری'); ?>"><?php echo _l('20 روز کاری'); ?></option>
                                     <option value="<?php echo _l('15 روز کاری'); ?>"><?php echo _l('25 روز کاری'); ?></option>
                                     <option value="<?php echo _l('1 ماه'); ?>"><?php echo _l('1 ماه'); ?></option>
                                     <option value="<?php echo _l('1 ماه'); ?>"><?php echo _l('1 ماه و نیم'); ?></option>
                                     <option value="<?php echo _l('2 ماه'); ?>"><?php echo _l('2 ماه'); ?></option>
                                     <option value="<?php echo _l('2 ماه'); ?>"><?php echo _l('2 ماه و نیم'); ?></option>
                                     <option value="<?php echo _l('3 ماه'); ?>"><?php echo _l('3 ماه'); ?></option>
                                     <option value="<?php echo _l('3 ماه'); ?>"><?php echo _l('3 ماه و نیم'); ?></option>
                                     <option value="<?php echo _l('4 ماه'); ?>"><?php echo _l('4 ماه'); ?></option>
                                 </select>
                             </div>
                         </div>
                         <div class="col-md-6">
