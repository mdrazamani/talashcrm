...
<div class="col-md-12 no-padding animated fadeIn">
    <div class="panel_s">
        ...
        <div class="panel-body">
            <h4 class="no-margin"><?php echo _l('ثبت پرداخت برای فاکتوره'); ?> <?php echo format_invoice_number($invoice->id); ?></h4>
           <hr class="hr-panel-heading" />
            <div class="row">
                <div class="col-md-6">
                    ...
                    $totalAllowed = 0;
                    echo render_input('amount','مبلغ دریافتی',$amount,'number',array('max'=>$amount)); ?>
                    <?php echo render_date_input('date','تاریخ پرداخت',_d(date('Y-m-d'))); ?>
                    <div class="form-group">
                        <label for="paymentmode" class="control-label"><?php echo _l('روش پرداخت'); ?></label>
                ...
                <div class="col-md-6">
                    <?php echo render_input('transactionid','شناسه تراکنش'); ?>
                       <div class="form-gruoup">
                            <label for="note" class="control-label"><?php echo _l('یادداشت پرداخت'); ?></label>
            ...
            <div class="pull-right mtop15">
                <a href="#" class="btn btn-danger" onclick="init_invoice(<?php echo $invoice->id; ?>); return false;"><?php echo _l('انصراف'); ?></a>
                <button type="submit" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>" data-form="#record_payment_form" class="btn btn-success"><?php echo _l('ذخیره'); ?></button>
            </div>
            <?php
            if($payments){ ?>
            <div class="mtop25 inline-block full-width">
                <h5 class="bold"><?php echo _l('مبالغ پرداختی دریافت شده'); ?></h5>
