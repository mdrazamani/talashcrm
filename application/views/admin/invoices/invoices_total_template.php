   ...
   <div class="col-lg-4 col-xs-12 col-md-12 total-column">
      <div class="panel_s">
         <div class="panel-body">
            ...
            <span class="text-warning"><?php echo _l('فاکتورهای معوق'); ?></span>
         </div>
      </div>
   </div>
   <div class="col-lg-4 col-xs-12 col-md-12 total-column">
      <div class="panel_s">
         <div class="panel-body">
            ...
            <span class="text-danger"><?php echo _l('فاکتورهای سررسید گذشته'); ?></span>
         </div>
      </div>
   </div>
   <div class="col-lg-4 col-xs-12 col-md-12 total-column">
      <div class="panel_s">
         <div class="panel-body">
            ...
            <span class="text-success"><?php echo _l('فاکتورهای پرداخت شده'); ?></span>
         </div>
      </div>
   </div>
</div>
