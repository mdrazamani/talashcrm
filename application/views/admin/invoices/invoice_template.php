...
<div class="mz-panel invoice accounting-template">
    <div class="mz-panel-header">
        <span class="dash-micon"><i class="my-ti ti ti-file-plus"></i></span>
        <span class="dash-mtext">فاکتور جدید</span>
    </div>
      ...
      <div class="row">
         <div class="col-md-6">
            ...
            <div class="form-group select-placeholder projects-wrapper<?php if((!isset($invoice)) || (isset($invoice) && !customer_has_projects($invoice->clientid))){ echo (isset($customer_id) && (!isset($project_id) || !$project_id)) ?  ' hide' : '';} ?>">
               <label for="project_id"><?php echo _l('پروژه'); ?></label>
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <p class="bold"><?php echo _l('صورت حساب به'); ?></p>
                  <address>
               ...
               <div class="col-md-6">
                  <p class="bold"><?php echo _l('حمل و نقل به'); ?></p>
                  <address>
            ...
            <div class="form-group">
               ...
               <div class="input-group">
                  <input type="text" name="number" class="form-control dirltr" value="<?php echo ($_is_draft) ? 'DRAFT' : $_invoice_number; ?>" data-isedit="<?php echo $isedit; ?>" data-original-number="<?php echo $data_original_number; ?>" <?php echo ($_is_draft) ? 'disabled' : '' ?>>
                   <span class="input-group-addon dirltr">
                  <?php if(isset($invoice)){ ?>
            ...
            <div class="row">
               <div class="col-md-6">
                  ...
                  ?>
                  <?php echo render_date_input('date','تاریخ فاکتور',$value,$date_attrs); ?>
               </div>
               <div class="col-md-6">
                  <?php
                  $value = '';
                  if(isset($invoice)){
                   ...
                   ?>
                  <?php echo render_date_input('duedate','تاریخ سررسید',$value); ?>
               </div>
            </div>
               ...
               <div class="form-group">
                  <div class="checkbox checkbox-danger">
                     ...
                     <label for="cancel_overdue_reminders"><?php echo _l('از ارسال یادآورهای معوق برای این فاکتور جلوگیری کنید') ?></label>
                  </div>
               </div>
               <?php } ?>
         ...
         <div class="col-md-6">
            <div class="panel_s no-shadow">
               ...
               <div class="form-group mbot15 select-placeholder">
                  <label for="allowed_payment_modes" class="control-label"><?php echo _l('پرداخت های مجاز برای این فاکتور'); ?></label>
                  <br />
               ...
               <div class="row">
                  <div class="col-md-6">
                     <?php
                        ...
                        ?>
                     <?php echo render_select('currency', $currencies, array('id','name','symbol'), 'ارز', $selected, $currency_attr); ?>
                  </div>
                  <div class="col-md-6">
                     <?php
                        $i = 0;
                        ...
                        echo render_select('sale_agent',$staff,array('staffid',array('firstname','lastname')),'نماینده فروش',$selected);
                        ?>
                  </div>
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                     <div class="form-group select-placeholder">
                        <label for="discount_type" class="control-label"><?php echo _l('نوع تخفیف'); ?></label>
               ...
               <?php echo render_textarea('adminnote','یادداشت مدیر',$value); ?>
   ...
   <div class="panel-body mtop10">
      <div class="row">
         ...
         <div class="col-md-<?php if(!isset($invoice_from_project)){ echo 5; }else {echo 8;} ?> text-right show_quantity_as_wrapper">
            <div class="mtop10">
               <span><?php echo _l('نمایش مقدار به صورت: '); ?> </span>
               <div class="radio radio-primary radio-inline">
                  ...
                  <label for="sq_1"><?php echo _l('تعداد'); ?></label>
               </div>
               <div class="radio radio-primary radio-inline">
                  ...
                  <label for="sq_2"><?php echo _l('ساعت ها'); ?></label>
               </div>
               <div class="radio radio-primary radio-inline">
                  ...
                  <label for="sq_3"><?php echo _l('تعداد'); ?>/<?php echo _l('ساعت'); ?></label>
               </div>
      ...
      <div class="table-responsive s_table">
         <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
            <thead>
               <tr>
                  <th></th>
                  <th width="20%" align="left"><i class="fa fa-exclamation-circle" aria-hidden="true" data-toggle="tooltip" data-title="<?php echo _l('item_description_new_lines_notice'); ?>"></i> <?php echo _l('آیتم'); ?></th>
                  <th width="25%" align="left"><?php echo _l('توضیحات'); ?></th>
                  <?php
   ...
   <div class="row">
      <div class="col-md-12 mtop15">
         <div class="panel-body bottom-transaction">
            ...
            <?php echo render_textarea('clientnote','یادداشت مشتری',$value,array(),array(),'mtop15'); ?>
            <?php $value = (isset($invoice) ? $invoice->terms : get_option('predefined_terms_invoice')); ?>
            <?php echo render_textarea('terms','شرایط و ضوابط',$value,array(),array(),'mtop15'); ?>
