         ...
         <div class="col-md-12">
            <div class="mz-panel">
               <div class="mz-panel-body">
                  <div class="_buttons">
                     <a href="<?php echo admin_url('leads/new_lead');?>" class="btn mright5 btn-info pull-left display-block">
                     <?php echo _l('اقدام جدید'); ?>
                     </a>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 pull-right leads-search">
                           ...
                           <?php echo form_hidden('sort',(get_option('default_leads_kanban_sort') != '' ? get_option('default_leads_kanban_sort_type') : '')); ?>
                            ...
                            <a href="<?php echo admin_url('leads/trashes');?>" class="btn mright5 btn-warning pull-left display-block">
                                <i class="ti ti-trash"></i>
                                <?php echo _l('اقدام های خاتمه یافته'); ?>
                            </a>
...
//                              );
                              ...
                              $_table_data[] =  array(
                               ...
                               $_table_data[] = array(
                                   'name'=>_l('ایجاد کننده'),
                                   'th_attrs'=>array('class'=>'toggleable', 'id'=>'th-added')
                               );
                              $_table_data[] = array(
                               'name'=>_l('اختصاص یافته به '),
...
<?php //$this->view('admin/leads/convertToProject');?>

<div class="modal fade lead-modal" id="customer_group_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" style="display: none;">
