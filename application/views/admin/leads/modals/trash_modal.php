...
<div class="modal-header">
    ...
    <h4 class="modal-title">
        <?php if(isset($lead)){
            ...
            echo _l('اقدام جدید',_l('lead_lowercase'));
        }
        ?>
    </h4>
</div>
<div class="modal-body">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="top-lead-menu">
                <div class="horizontal-scrollable-tabs preview-tabs-top">
                    ...
                    <div class="horizontal-tabs">
                        <ul id="clickUl" class="nav-tabs-horizontal nav nav-tabs<?php if(!isset($lead)){echo ' lead-new';} ?>" role="tablist">
            ...
            <!-- Tab panes -->
            <div id="tab-content" class="tab-content mtop20">
                <!-- from leads modal -->
...
<script>
    let li_nav = document.getElementById('clickUl').children;
    let tabContent = document.getElementById('tab-content').children;
   // ul.addEventListener('click',()=>{

    for(let i=0; i<li_nav.length; i++){
        li_nav[i].addEventListener('click',()=>{
            //console.log(li_nav[i].firstElementChild);
            for(let j=0; j<li_nav.length; j++){
                li_nav[j].firstElementChild.classList.remove('active');
                tabContent[j].style.display="none";
            }
            li_nav[i].firstElementChild.classList.add('active');
