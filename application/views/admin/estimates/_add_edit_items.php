...
<div class="panel-body mtop10">
        ...
        <div class="col-md-8 text-right show_quantity_as_wrapper">
            <div class="mtop10">
                ...
                <div class="radio radio-primary radio-inline">
                    ...
                    <label for="1"><?php echo _l('تعداد'); ?></label>
                </div>
                <div class="radio radio-primary radio-inline">
                    ...
                    <label for="2"><?php echo _l('ساعت ها'); ?></label>
                </div>
                <div class="radio radio-primary radio-inline">
                    ...
                    <label for="3"><?php echo _l('تعداد'); ?>/<?php echo _l('ساعت'); ?></label>
                </div>
            </div>
        </div>
    </div>
    <div class="table-responsive s_table">
        <table class="table estimate-items-table items table-main-estimate-edit has-calculations no-mtop">
            ...
            <tr>
                <th></th>
                <th width="20%" align="center"><i class="fa fa-exclamation-circle" aria-hidden="true" data-toggle="tooltip" data-title="<?php echo _l('item_description_new_lines_notice'); ?>"></i> <?php echo _l('آیتم'); ?></th>
                <th width="25%" align="center"><?php echo _l('توضیحات'); ?></th>
                <?php
...
<!--                <th width="20%" align="right">--><?php //echo _l('estimate_table_tax_heading'); ?><!--</th>-->
            ...
            <tr class="main">
                <td></td>
                <td>
                    <textarea name="description" rows="4" class="form-control" placeholder="<?php echo _l('عنوان کالا'); ?>"></textarea>
                </td>
                <td>
                    <textarea name="long_description" rows="4" class="form-control" placeholder="<?php echo _l('توضیحات کالا'); ?>"></textarea>
                </td>
                ...
                <td>
                    ...
                    <input type="text" placeholder="<?php echo _l('واحد'); ?>" name="unit" class="form-control input-transparent text-right">
                </td>
                <td>
                    <input type="number" name="rate" class="form-control" placeholder="<?php echo _l('قیمت'); ?>">
                </td>
                <td style="display:none;">
                    <?php
                    $select = '<select class="tax"';
                    $select .= '</select>';
                    echo $select;
                    ?>
                </td>
    ...
    <div class="col-md-8 col-md-offset-4">
        <table class="table text-right">
            <tbody>
            <tr id="subtotal">
                <td><span class="bold"><?php echo _l('جمع'); ?> :</span>
                </td>
                <td class="subtotal">
                </td>
            </tr>
            <tr id="discount_area">
                <td>
                    <div class="row">
                        <div class="col-md-7">
                            <span class="bold"><?php echo _l('تخفیف'); ?></span>
                        </div>
                        <div class="col-md-5">
            ...
            <tr>
                <td>
                    <div class="row">
                        <div class="col-md-7">
                            <span class="bold"><?php echo _l('هزینه اضافه'); ?></span>
                        </div>
                        <div class="col-md-5">
            ...
            <tr>
                <td><span class="bold"><?php echo _l('جمع کل'); ?> :</span>
                </td>
                <td class="total">
                </td>
            </tr>
