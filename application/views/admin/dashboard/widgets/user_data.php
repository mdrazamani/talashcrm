...
<div class="widget" id="widget-<?php echo create_widget_id(); ?>" data-name="<?php echo _l('user_widget'); ?>">
   <div class="mz-panel user-data">
       <div class="mz-panel-header">
           <span class="dash-micon"><i class="my-ti ti ti-database"></i></span>
           <span class="dash-mtext">اقدامات من</span>
       </div>
      <div class="mz-panel-body home-activity">
            ...
            <div class="horizontal-tabs">
               <ul class="nav nav-tabs nav-tabs-horizontal" role="tablist">
                  <li role="presentation" class="active">
                     <a href="#home_tab_tasks" aria-controls="home_tab_tasks" role="tab" data-toggle="tab">
                        <i class="fa fa-tasks menu-icon"></i> <?php echo _l('وظایف من'); ?>
                     </a>
                  </li>
                  <li role="presentation">
                     ...
                     <i class="fa fa-bars menu-icon"></i> <?php echo _l('پروژه های من'); ?>
                     </a>
                  </li>
                  <li role="presentation">
                     ...
                     <i class="fa fa-clock-o menu-icon"></i> <?php echo _l('یادآوری های من'); ?>
                     <?php
                  ...
                  <li role="presentation">
                     ...
                     <i class="fa fa-ticket menu-icon"></i> <?php echo _l('تیکت ها'); ?>
                     </a>
                  </li>
                  <?php } ?>
                  ...
                  <li role="presentation">
                     ...
                     <i class="fa fa-bullhorn menu-icon"></i> <?php echo _l('اطلاعیه ها'); ?>
                  ...
                  <li role="presentation">
                     ...
                     <i class="fa fa-window-maximize menu-icon"></i> <?php echo _l('آخرین فعالیت ها'); ?>
                     </a>
                  </li>
                  <?php } ?>
               ...
               <div class="tab-content">
                  <div role="tabpanel" class="tab-pane active" id="home_tab_tasks">
                     <a href="<?php echo admin_url('tasks/list_tasks'); ?>" class="mbot20 inline-block full-width"><?php echo _l('مشاهده همه'); ?></a>
