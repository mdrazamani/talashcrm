      ...
      <div class="col-md-12">
         <div class="mz-panel">
             <div class="mz-panel-header">
                 <div class="row">
                     <div class="col-md-6">
                         <span class="dash-micon"><i class="my-ti ti ti-checklist"></i></span>
                         <span class="dash-mtext">پرداختی ها</span>
                     </div>
                     <div class="col-md-6">
                        <div class="mleft35">
                            <a href="<?php echo admin_url('reports/sales'); ?>" class="pull-right mtop5"><?php echo _l('مشاهده همه'); ?></a>
                            <div class="dropdown pull-right mtop5 mright10">
                                <a href="#" id="PaymentChartmode" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span id="Payment-chart-name" data-active-chart="weekly"> <?php echo _l('هفتگی') ?> </span>
                                    <i class="fa fa-caret-down" aria-hidden="true"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="PaymentChartmode">
                                    <li>
                                        <a href="#" data-type="weekly" onclick="update_payment_statistics(this); return false;"><?php echo _l('هفتگی') ?></a>
                                    </li>
                                    <li>
                                        <a href="#" data-type="monthly" onclick="update_payment_statistics(this); return false;"><?php echo _l('ماهانه') ?></a>
                                    </li>
                                </ul>
                            </div>
