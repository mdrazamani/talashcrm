...
<div class="widget" id="widget-<?php echo create_widget_id(); ?>" data-name="<?php echo _l('home_my_todo_items'); ?>">
   <div class="mz-panel todo-panel">
       <div class="mz-panel-header">
           <div class="row">
               <div class="col-md-5">
                   <span class="dash-micon"><i class="my-ti ti ti-checkbox"></i></span>
                   <span class="dash-mtext">کار های من </span>
               </div>
               <div class="col-md-7">
                   <div class="mleft35">
                       <a href="<?php echo admin_url('todo'); ?>" class="pull-right padding-5">&nbsp;|&nbsp;<?php echo _l('مشاهده همه'); ?></a>
                       <a href="#__todo" data-toggle="modal" class="pull-right padding-5" style="padding-right:0px;">
                           <?php echo _l('کار جدید'); ?>
                       </a>
                   </div>
               </div>
           </div>
